                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: Padding(
                            ...
                            child: CustomTextField(labelText: 'Location'),
                          ),
                        ),
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        if (passwordController.passwordStrength.value == 0)
                          Padding(
                        ...
                        Padding(
                          ...
                          child: Obx(() => PasswordStrengthIndicator(
                              strengthLevel:
                                  passwordController.passwordStrength.value)),
                        ),
                      ],
                    ),
                    Row(
